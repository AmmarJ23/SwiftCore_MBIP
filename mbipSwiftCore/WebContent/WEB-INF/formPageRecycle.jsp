...
<body>
    ...
    <div class="box">
        ...
        <% 
        Recycle e = (Recycle) request.getAttribute("eObj");
        if (e == null) { %>

        <form action="${pageContext.request.contextPath}/recycle/add">

            <div name="row">

                <div class="container">
                    Recycle Consumption </br>
        ...
        <form action="${pageContext.request.contextPath}/recycle/update">
