...
<body>
	<div class="overlay">
		...
		<form style="background-color: white;" action="${pageContext.request.contextPath}/user/login" method="POST">
			...
			<img src="${pageContext.request.contextPath}/resources/img/mbip.jpg" alt="gambar mbip" width="100" height="100" title="mbip">
				...
				<div class="other">
					...
					<a href="${pageContext.request.contextPath}/user/signupForm" style="color: green;">SIGN UP</a>
